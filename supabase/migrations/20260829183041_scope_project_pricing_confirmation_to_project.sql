drop function if exists public.wpi_confirm_project_pricing_item(uuid, numeric, text, numeric, text, text, uuid, uuid);
...
revoke all on function public.wpi_confirm_project_pricing_item(uuid, uuid, numeric, text, numeric, text, text, uuid, uuid)
  from public, anon;
grant execute on function public.wpi_confirm_project_pricing_item(uuid, uuid, numeric, text, numeric, text, text, uuid, uuid)
